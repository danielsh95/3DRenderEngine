...
public class ReflectionRefractionTests {
    ...
    public void twoSpheres() {
        ...
        scene.addGeometries(
                new Sphere(new Material(0.3, 0, 0.4, 0.3, 100), new Color(java.awt.Color.BLUE),
    ...
    public void twoSpheresOnMirrors() {
        ...
        scene.addGeometries(
                new Sphere(new Material(0.5, 0, 0.25, 0.25, 20), new Color(0, 0, 100), new Point3D(-950, 900, 1000), 400),
                new Sphere(new Material(0.25, 0.25, 20), new Color(100, 20, 20), new Point3D(-950, 900, 1000), 200),
                new Triangle(new Material(0, 1, 0, 0, 0), new Color(20, 20, 20), new Point3D(1500, 1500, 1500),
                        new Point3D(-1500, -1500, 1500), new Point3D(670, -670, -3000)),
                new Triangle(new Material(0, 0.5, 0, 0, 0), new Color(20, 20, 20), new Point3D(1500, 1500, 1500),
    ...
    public void trianglesTransparentSphere() {
        ...
        scene.addGeometries( //
                ...
                new Sphere(new Material(0.6, 0, 0.2, 0.2, 30), new Color(java.awt.Color.BLUE),  // )
