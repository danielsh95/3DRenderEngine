...
public class CameraTests {
    ...
    /**
     * Test method for
     * {@link element.Camera#constructRayThroughPixel(int, int, int, int, double, double, double)}.
     */
    @Test
